...
namespace caffe {
    ...
    void metal_wrapper(std::string funcname_, void* in_data, const int in_data_szie, void* out_data, const int out_data_size, std::vector<int> para_int, std::vector<float> para_float, int count);
    void metal_wrapper3(std::string funcname_, void* in_data, const int in_data_size, void* out_data,  const int out_data_size, void* inter_data,  const int inter_data_size, std::vector<int> para_int, std::vector<float> para_float, int count);
    void metal_wrapper4(std::string funcname_, void* in_data, const int in_data_size, void* out_data,  const int out_data_size, void* other1_data,  const int other1_data_size, void* other2_data,  const int other2_data_size, std::vector<int> para_int, std::vector<float> para_float, int count);
...
template <typename Dtype>
void caffe_gpu_gemm_metal(const CBLAS_TRANSPOSE TransA,
    const CBLAS_TRANSPOSE TransB, const int M, const int N, const int K,
    const double alpha, const Dtype* A, const int A_offset, const Dtype* B, const int B_offset, const double beta,
    Dtype* C, const int C_offset);

template <typename Dtype>
void caffe_gpu_gemv_metal(const CBLAS_TRANSPOSE TransA, const int M, const int N,
    const double alpha, const Dtype* A, const Dtype* x, const double beta,
    Dtype* y);
    
template <typename Dtype>
void caffe_gpu_axpy_metal(const int N, const Dtype alpha, const Dtype* X,
                        Dtype* Y);
