...
//            }
//            caffe_gpu_gemm_metal<TypeParam>(CblasNoTrans, CblasNoTrans, 2, 4, 3, 1.,
//                                      A.gpu_data(), 0, B.gpu_data(), 0, 0., C.mutable_gpu_data(), 0);
//            for (int i = 0; i < 8; ++i) {
//                EXPECT_EQ(C.cpu_data()[i], result[i]);
//            }
//
...
//                EXPECT_EQ(C.cpu_data()[i], result[i]);
//            }
//            caffe_gpu_gemm_metal<TypeParam>(CblasTrans, CblasNoTrans, 2, 4, 3, 1.,
//                                      A.gpu_data(), 0, B.gpu_data(), 0, 0., C.mutable_gpu_data(), 0);
//            for (int i = 0; i < 8; ++i) {
//                EXPECT_EQ(C.cpu_data()[i], result[i]);
//            }
...
//                EXPECT_EQ(C.cpu_data()[i], result[i]);
//            }
//            caffe_gpu_gemm_metal<TypeParam>(CblasTrans, CblasTrans, 2, 4, 3, 1.,
//                                      A.gpu_data(), 0, B.gpu_data(), 0, 0., C.mutable_gpu_data(), 0);
//            for (int i = 0; i < 8; ++i) {
//                EXPECT_EQ(C.cpu_data()[i], result[i]);
//            }
...
//                EXPECT_EQ(C.cpu_data()[i], result[i]);
//            }
//            caffe_gpu_gemm_metal<TypeParam>(CblasNoTrans, CblasTrans, 2, 4, 3, 1.,
//                                      A.gpu_data(), 0, B.gpu_data(), 0, 0., C.mutable_gpu_data(), 0);
//            for (int i = 0; i < 8; ++i) {
//                EXPECT_EQ(C.cpu_data()[i], result[i]);
//            }
...
//            }
//            caffe_gpu_gemv_metal<TypeParam>(CblasNoTrans, 2, 3, 1., A.gpu_data(),
...
//            }
//
//            TypeParam data1[2] = {1,0};
//            TypeParam data2[6] = {2, 3, 2, 2, 2, 2};
//
//            //caffe_copy(2, data1, y.mutable_cpu_data());
//            //caffe_copy(6, data2, A.mutable_cpu_data());
//
//
//            caffe_gpu_gemv_metal<TypeParam>(CblasTrans, 2, 3, 1., A.gpu_data(),
...
//
//            for (int i = 0; i < 3; ++i) {
//                //std::cout << "it is "<< x.cpu_data()[i] << std::endl;
//                EXPECT_EQ(x.cpu_data()[i], result_3[i]);
//            }
//        } else {
//            LOG(ERROR) << "Skipping test due to old architecture.";
