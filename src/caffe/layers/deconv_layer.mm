...
void DeconvolutionLayer<Dtype>::Forward_gpu(const vector<Blob<Dtype>*>& bottom,
    ...
    std::vector<int> params = {2, static_cast<int>(conv_param.group()), (bottom[0]->shape(1) * top[0]->shape(1) * kernel_shape_data[0] * kernel_shape_data[1]), (bottom[0]->count()), (top[0]->count()), (bottom[0]->shape(2)), (top[0]->shape(2)), (bottom[0]->shape(3)), (top[0]->shape(3)), (bottom[0]->shape(2)*bottom[0]->shape(3)), (top[0]->shape(2) * top[0]->shape(3)), kernel_shape_data[0], kernel_shape_data[1],(kernel_shape_data[0] * kernel_shape_data[1]), pad_data[0], pad_data[1], stride_data[0], stride_data[1], dilation_data[0], dilation_data[1], (bottom[0]->shape(1)), (top[0]->shape(1)), (top[0]->shape(1)), top[0]->shape(1) / static_cast<int>(conv_param.group()),  (top[0]->shape(2) * top[0]->shape(3)), bottom[0]->shape(1)*kernel_shape_data[0] * kernel_shape_data[1], bottom[0]->shape(1)*kernel_shape_data[0] * kernel_shape_data[1]/static_cast<int>(conv_param.group()), ((((bottom[0]->shape(1)*kernel_shape_data[0] * kernel_shape_data[1]/static_cast<int>(conv_param.group())) - 1)/(8*2) + 1)*2)};
    ...
    if(this->bias_term_){
        funcname = @"deconv_bias";
    } else {
        funcname = @"deconv_no_bias";
    }
    ...
    [encoder setBuffer:out_gpu  offset:0 atIndex:0];
    [encoder setBuffer:in_gpu  offset:0 atIndex:1];
